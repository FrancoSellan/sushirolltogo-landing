...
import { COMBINADOS_RECTA_MARTINOLLI as combinados } from "@/app/constants/productos/recta-martinolli/combinados.const";
  ...
  return (
    <section>
      ...
      >
        ...
        <div className="h-px flex-1 bg-linear-to-r from-amber-500/50 to-zinc-800" />
      </motion.div>
